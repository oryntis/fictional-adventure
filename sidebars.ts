 ...
 * This simplifies the sidebar by automatically including all docs in the `docs` folder.
 * It avoids missing document ID errors that arise from manually listing non‑existent files.
 */
              ...
              items: [
                {
                  type: "category",
                  label: "Cosmos IR",
                  items: ["phases/B-pre-kernel/tasks/ir/index"],
                },
                {
                  type: "category",
                  label: "HAL Skeleton",
                  items: ["phases/B-pre-kernel/tasks/hal/index"],
                },
                {
                  type: "category",
